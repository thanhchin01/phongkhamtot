...
@section('content')
    <div class="main-body p-3 mt-2 container mx-auto">
        <span class="text-sm sticky top-20 self-start"><a href=" {{url('')}} " class="hover:text-[#22d69f]">Trang chủ</a>/ <a
                href=" {{url('huongdan')}} " class="hover:text-[#22d69f]">Hướng dẫn</a>/Quản lý tin</span>
        <div class="flex gap-4">
            <div class="w-4/12 p-4 gap-4 flex flex-col sticky top-24 self-start">
                <a href=" {{url('huongdan')}} " class="bg-gray-200 px-4 py-3 rounded-lg font-bold">Hưỡng dẫn tìm
                    kiếm</a>
                <a href=" {{url('hdtaotaikhoan')}} khoan" class="bg-gray-200 px-4 py-3 rounded-lg font-bold">Tạo tài
                    khoản</a>
                <a href=" {{url('hddangtin')}} n" class="bg-gray-200 px-4 py-3 rounded-lg font-bold">Hưỡng dẫn đăng
                    tin</a>
                <a href=" {{url('quanlytin')}} n" class="bg-blue-500 px-4 py-3 rounded-lg font-bold">Quản lý tin</a>
            </div>
