    ...
    <div class="main-body">
        ...
        <section class="max-w-[1350px] mx-auto mt-4 p-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 items-center">
                ...
                <a href=" {{url('blog')}} " class="text-right text-blue-600 hover:underline text-sm sm:text-base">Xem thêm</a>
            </div>
